...
-   [DSCI-522 Individual Assignment2 for Tanmay Sharma (cwl:
    tshar19)](#dsci-522-individual-assignment2-for-tanmay-sharma-cwl-tshar19)
    -   [Aim](#aim)
    -   [Data](#data)
    -   [Methods](#methods)
    -   [Results](#results)
...
# DSCI-522 Individual Assignment2 for Tanmay Sharma (cwl: tshar19)
